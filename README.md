# Projeto Final Disciplina de Programação Concocorrente - 2026-01
...
* G3 - Contador de lotação em vagão ou estação de metrô  
Oliver  
Marcos  
https://github.com/oliverhenrique04/Projeto_Comp_Par_Dist  

* G4 - Montar um analizador paralelo de NF (somar todos os valores, verificar historicos de evolução de preços de itens, encontrar o maior e o menor valor)  
Lucas  
Jõao Gabriel  
...
Matheus Dantas  
Luis Gustavo  
https://github.com/Haicks/detector-de-palavr-es.git
